...
namespace RailwayStation.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainJourneys", x => x.JourneyID);
                    table.ForeignKey(
                        name: "FK_TrainJourneys_TrainStations_ArrivalStationID",
                        column: x => x.ArrivalStationID,
                        principalTable: "TrainStations",
                        principalColumn: "StationID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainJourneys_TrainStations_DepartureStationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainJourneys_ArrivalStationID",
                table: "TrainJourneys",
                column: "ArrivalStationID");

            migrationBuilder.CreateIndex(
                name: "IX_TrainJourneys_DepartureStationID",
                table: "TrainJourneys",
